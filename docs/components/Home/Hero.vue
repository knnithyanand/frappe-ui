    ...
    <div class="my-20 p-5 flex flex-col gap-5 text-center w-fit">
      ...
      <div class="flex gap-3 mt-2 mx-auto">
        <a
          ...
          class="inline-flex items-center gap-2 h-8 px-2.5 rounded text-base font-medium text-ink-white bg-surface-gray-7 hover:bg-surface-gray-6 active:bg-surface-gray-5 transition-colors focus:outline-hidden focus-visible:ring-3 focus-visible:ring-outline-gray-3"
        >
          Get Started
